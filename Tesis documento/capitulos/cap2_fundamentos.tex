...
medio \cite{PatelTam1981}.

De ahí se sigue también lo que ocurre cuando esa normalización no
está disponible: sin una medida de $E_0$, la amplitud registrada
conserva el producto $E_0\,\alpha$ y no permite despejar el
coeficiente de absorción. El arreglo descrito en el
\cref{cap:arreglo} no incorpora un sensor calibrado de energía, de
modo que el análisis de las señales se apoya en su forma temporal y
en su contenido espectral y no en su amplitud absoluta.
...
del osciloscopio y el registro de la temperatura de la muestra. Realizada manualmente,
