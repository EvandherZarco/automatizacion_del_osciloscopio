...
\subsection*{Alcance de la caracterización del transductor}

La caracterización del hidrófono, incluida su respuesta en
frecuencia, corresponde al trabajo en el que fue desarrollado y se
recoge aquí únicamente como condición de frontera del experimento
\cite{Rangel2023}. Este trabajo no la reproduce ni la discute: el
transductor es, como el osciloscopio, un instrumento
intercambiable del arreglo, y su desempeño no condiciona la validez
del sistema de automatización sino la interpretación de las señales
que ese sistema registra.

Interesa, eso sí, la consecuencia metodológica: el análisis
espectral de las señales adquiridas caracteriza conjuntamente al
líquido y al transductor, de modo que la comparación entre líquidos
distintos solo es válida en tanto el transductor permanezca
invariante. El desarrollo
