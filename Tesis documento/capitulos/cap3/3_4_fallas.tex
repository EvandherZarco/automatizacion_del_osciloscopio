...
Esta sección documenta tres fallas ocurridas en sesiones reales,
...
la auditoría del código. Los tres casos provienen de registros que
existen en el repositorio y pueden reconstruirse.
...
módulo de temperatura ya integrado a la aplicación. Consta de
diecisiete capturas repartidas en dos series, separadas por una
reprogramación del microcontrolador ESP32 a mitad de sesión.
...
\subsection{Falla detectada en la verificación posterior: buffer
duplicado tras un cambio de escala}
...
poco confiable. La sesión del 25 de agosto demuestra lo contrario.

Sus diecisiete capturas se tomaron con dos escalas horizontales
distintas, y el máximo de la señal aparece en índices de muestra muy
diferentes según la serie: alrededor de la muestra 13\,641 en la
primera y de la 6\,729 en la segunda. Reconstruidas con sus respectivos
parámetros, las diecisiete sitúan el máximo en \SI{69.1}{\micro\second}
con una dispersión de \SI{0.1}{\micro\second}. Dos muestreos distintos
convergen al mismo instante físico.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{3.6cm}p{2.6cm}p{3.4cm}p{3.2cm}}
    ...
    \addlinespace
    Buffer duplicado tras un cambio de escala &
    Verificación posterior &
    Arreglos idénticos con parámetros distintos &
...
Tres de las cinco anomalías no eran observables durante la operación.
Dos de ellas tampoco lo eran en los datos: solo aparecieron al
contrastar el archivo con lo que declaraba contener y el código con su
propia historia. Ninguna produjo una excepción ni interrumpió una
secuencia.
