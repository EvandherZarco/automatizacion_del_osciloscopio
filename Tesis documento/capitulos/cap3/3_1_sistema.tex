...
secuencia, consulta a los tres instrumentos y es el único que escribe en
el registro de sesión. El de conexión y monitoreo no participa en la
secuencia; vigila el estado de los enlaces de forma continua y en
paralelo, de modo que la pérdida de un dispositivo se detecta también
fuera de una medición en curso.

\input{capitulos/fig_arquitectura}
...
\input{capitulos/fig_modulo_temperatura}
