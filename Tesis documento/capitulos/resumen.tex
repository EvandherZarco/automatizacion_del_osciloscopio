...
ellas en lugar de aparentar normalidad. Se documentan siete anomalías
...
posterior de los datos, en la auditoría del código, o al provocar
deliberadamente la condición frente al instrumento—, incluida una que
tuvo como origen la propia herramienta de verificación. Seis de las
siete no eran observables mientras ocurrían, y todas las que se
manifestaron resultaron reconstruibles a partir de la información
conservada en los archivos de sesión.
Esa reconstruibilidad es la propiedad que el sistema aporta al
